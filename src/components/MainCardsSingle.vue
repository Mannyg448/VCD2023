...
<style scoped lang="postcss">
  .card {
    @apply cursor-pointer overflow-hidden rounded-md bg-purple-500 p-8 shadow-md transition-transform duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-orange-900;
    &-image {
      img {
    ...
    &-details {
      ...
      &-name {
        @apply text-3xl font-thin  tracking-wider text-green-500;
      }
      &-job {
        @apply -mt-2 text-xs font-bold text-black;
      }
      &-quote {
        @apply pt-4 text-lg font-bold italic text-green-500;
      }
    }
  }
</style>